...
class Page
{
    ...
    {
        return View::render('views/public/includes/header', []);
    }
    ...
    {
        return View::render('views/public/includes/footer', []);
    }
    ...
    {
        return View::render('views/public/includes/links', []);
    }
    ...
    {
        return View::render('views/public/includes/scriptlinks', []);
    }
    ...
    public static function getPagination($request, $obPagination)
    {
        ...
        foreach ($pages as $page) {
            ...
            // VIEW
            $links .= View::render('views/public/includes/pagination/link', [
                'page' => $page['page'],
                'pagelink' => $link,
        ...
        return View::render('views/public/includes/pagination/box', [
            'pages' => $links,
        ]);
    }
